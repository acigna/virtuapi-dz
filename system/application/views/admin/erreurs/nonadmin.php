<?php
  ...
  $this->oms->partie_haute("Page strictement reservée aux administrateurs");
?>

<p style="text-align:center;"><img src="<?php echo base_url(); ?>images/acces_interdit.png" alt="Accés interdit à cette partie"/>
</p>
<p style="font-size:15px;text-align:center;">Désolé, mais cette page est strictement réservée aux administrateurs.</p>	   
