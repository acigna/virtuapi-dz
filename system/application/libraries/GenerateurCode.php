...
class GenerateurCode
{
    ...
    function getCaptcha()
    {
        ...
        switch($function)
        {
            case "_captchaLettres":
                return $this->_captchaLettres();
                
            case "_captchaCalculChiffres":
                return $this->_captchaCalculChiffres(); 
            
            case "_captchaCalculLettres":
                return $this->_captchaCalculLettres();
            
            case "_captchaAlphaNum":
                return $this->_captchaAlphaNum();              
        }
    }
